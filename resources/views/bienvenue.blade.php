...
@section('content')
	<div class='container'>
		...
		<p>Pour jouer, vous devez d'abord vous enregistrer, puis créer au moins un élevage, un budget vous sera alloué pour acheter des reproducteurs et effectuer des actes vétérinaires. Vous pourrez aussi vendre des chevaux.</p>
