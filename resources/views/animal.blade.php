			...
			<div id='saillie'>
				...
				<div>
					@isset($animal->StatutMale)
						@if ($animal->StatutMale->qualite == 'entier'  && $animal->statut_administratif == 'enregistré' && $animal->elevage_id == $elevage->id && ($animal->race->age_repro_male >= $animal->ageAdministratif))
