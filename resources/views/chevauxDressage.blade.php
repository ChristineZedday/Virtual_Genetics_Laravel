...
<tr>
	...
	<th>Niveau Dressage <button onclick="tri(7, ASC)"> &#x23F6;</button><button onclick="tri(7, DESC)"> &#x23F7;</button></th>
		<th>Indice Dressage (IDR) cheval et poney<button onclick="tri(7, ASC)"> &#x23F6;</button><button onclick="tri(7, DESC)"> &#x23F7;</button></th>
...
@include('includes.petiteImage')
  ...
  <td> {{ $animal->taille() }}  </td>
	...
	<td>{{(int)($animal->Performance->IDR_cheval)}} &nbsp; {{(int)($animal->Performance->IDR_poney)}} </td>
